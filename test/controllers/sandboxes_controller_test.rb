...
class SandboxesControllerTest < ActionController::TestCase
  ...
  test "should create sandbox" do
    assert_difference('Sandbox.count') do
      post :create, sandbox: { creator_id: @sandbox.creator_id, public: @sandbox.public, sessionId: @sandbox.sessionId }
    end
  ...
  test "should update sandbox" do
    patch :update, id: @sandbox, sandbox: { creator_id: @sandbox.creator_id, public: @sandbox.public, sessionId: @sandbox.sessionId }
    assert_redirected_to sandbox_path(assigns(:sandbox))
  end
